...
var countDownDate = new Date("Sep 20, 2025 17:30").getTime();
...
var x = setInterval(function () {
  ...
  <div class="d-flex justify-content-center">
    <div class="cuenta txt-gray-white px-4 pb-4 pt-0" >
  <span>${days} días</span>
...
// Detectar si es iPhone o Safari
const ua = navigator.userAgent;

// iPhone
const esIphone = /iPhone/i.test(ua);

// Safari (pero no Chrome en iOS)
const esSafari = /^((?!chrome|android).)*safari/i.test(ua);

// Si es iPhone o Safari, cambiar el estilo
if (esIphone || esSafari) {
  document.querySelectorAll(".window-back-2").forEach((el) => {
